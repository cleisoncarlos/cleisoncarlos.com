...
function Form() {
  ...
  return (
    <>
      ...
      <p className="py-6">
        Transforme sua empresa com as tecnologias mais modernas! Entre em
        contato conosco e descubra como impulsionar seu sucesso no mundo
        digital.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn btn-error mt-5">
          Enviar mensagem
        </button>
      </form>
    </>
